...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <div className="ph-sans relative z-10 flex-1 px-4 py-7">
        ...
        <nav className="space-y-1">
          <NavLink to="/admin" end className={linkClass}>
            <svg viewBox="0 0 20 20" fill="none" className="h-4 w-4 shrink-0">
              ...
              <rect x="11.5" y="2.5" width="6" height="6" stroke="currentColor" strokeWidth="1.3" />
              <rect x="2.5" y="11.5" width="6" height="6" stroke="currentColor" strokeWidth="1.3" />
              <rect x="11.5" y="11.5" width="6" height="6" stroke="currentColor" strokeWidth="1.3" />
            </svg>
            Dashboard
          </NavLink>
          ...
          <NavLink to="/admin/projects" className={linkClass}>
            <svg viewBox="0 0 20 20" fill="none" className="h-4 w-4 shrink-0">
              <rect x="3" y="3" width="14" height="14" stroke="currentColor" strokeWidth="1.3" />
            </svg>
            Projects
          </NavLink>
        </nav>
        ...
        <nav className="space-y-1">
          <NavLink to="/admin/create-project" className={linkClass}>
            <svg viewBox="0 0 20 20" fill="none" className="h-4 w-4 shrink-0">
              <path d="M10 4v12M4 10h12" stroke="currentColor" strokeWidth="1.3" />
            </svg>
            New Project
          </NavLink>
        </nav>
